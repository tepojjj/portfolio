...
values
  (
    ...
    '/project-images/inventory-reconciliation.webp',
  ...
  (
    ...
    '/project-images/warehouse-ops-console.webp',
  ...
  (
    ...
    '/project-images/retail-analytics.webp',
  ...
  (
    ...
    '/project-images/fuzzy-import.webp',
  ...
  (
    ...
    '/project-images/inventory-classifier.webp',
