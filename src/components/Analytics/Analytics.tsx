              ...
              <AreaChart data={salesTrend}>
                <defs>
                  <linearGradient id="salesFill" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="#3ed9c4" stopOpacity={0.35} />
                ...
                <Area type="monotone" dataKey="sales" stroke="#3ed9c4" strokeWidth={2} fill="url(#salesFill)" />
              </AreaChart>
            </ResponsiveContainer>
          </ChartPanel>
        </RevealOnScroll>
          ...
          <ChartPanel title="REVENUE BY CHANNEL">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={revenueByChannel} layout="vertical" margin={{ left: 12 }}>
                ...
                <Bar dataKey="revenue" fill="#e3a857" radius={[0, 3, 3, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </ChartPanel>
        </RevealOnScroll>
          ...
          <ChartPanel title="Q4 FORECAST (PROJECTED)">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={forecast}>
                ...
                <Line type="monotone" dataKey="actual" stroke="#3ed9c4" strokeWidth={2} dot={{ r: 3 }} connectNulls={false} />
                <Line type="monotone" dataKey="forecast" stroke="#e3a857" strokeWidth={2} strokeDasharray="4 4" dot={{ r: 3 }} />
              </LineChart>
            </ResponsiveContainer>
          </ChartPanel>
        </RevealOnScroll>
